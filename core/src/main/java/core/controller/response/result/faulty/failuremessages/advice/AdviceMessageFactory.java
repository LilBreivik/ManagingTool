...
public class AdviceMessageFactory {
	...
	public static AdviceMessage createMissingAssetFileAdviceMessage(String name) {
		
		return new AdviceMessage("Die Datei " + name + " kann nicht heruntergeladen werden, da sie nicht exisitiert" + "\r\n" 
