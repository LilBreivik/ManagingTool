...
import core.backend.REST.fileasset.delete.parameter.request.DeleteLectureScheduleFileParameter;
...
public class LectureScheduleDeleteFileController 
										extends  DeleteScheduleFileController< DeleteLectureScheduleFileParameter , String>{
