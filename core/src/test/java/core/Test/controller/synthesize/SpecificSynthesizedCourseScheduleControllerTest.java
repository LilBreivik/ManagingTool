...
@WebMvcTest( SpecificSynthesizedCourseScheduleController .class)
@EnableAspectJAutoProxy(proxyTargetClass=true)
public class  SpecificSynthesizedCourseScheduleControllerTest {
     ...
     public void setUpParameter() throws IOException {
		 ...
		 else if(testName.getMethodName().equals("TESTE_checkIfWeCanGetSynthesizedSchedules")){
		 ...
		 else if(testName.getMethodName().equals("TESTF_checkIfWeCanGetSynthesizedSchedules")){
	 ...
	 public void TESTE_checkIfWeCanGetSynthesizedSchedules() throws Exception {
        ...
        ObjectMapper mapper = new ObjectMapper();
		 ...
		 try {
			 ...
			 MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.post("/Synthesize/SpecificCourseSchedule")
	                           .contentType(MediaType.APPLICATION_JSON_VALUE)
	                           .content(jsonInString);
	 ...
	 public void TESTF_checkIfWeCanGetSynthesizedSchedules() throws Exception {
        ...
        ObjectMapper mapper = new ObjectMapper();
		 ...
		 try {
			 ...
			 String  expectedSynthesizedContent = new String(Files.readAllBytes(pathManagerToLecutreAssets.getPathOfFile( "WiInfBaSynthesized")), "UTF-8");
