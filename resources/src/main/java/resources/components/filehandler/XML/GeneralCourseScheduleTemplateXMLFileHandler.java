...
@Component 
public class GeneralCourseScheduleTemplateXMLFileHandler 
															extends XMLFileHandler {
 
	@Autowired
	public GeneralCourseScheduleTemplateXMLFileHandler(
			@Qualifier("FileAssetsManager for Lectures Assets") FileAssetsManager fileAssetsManager
			) {
